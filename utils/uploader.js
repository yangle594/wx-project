  ...
  upload: function (o) {
    ...
    function r(e) {
      "function" == typeof o.start && o.start(e), t.core.uploadFile({
        ...
        formData: o.data || {},
        success: function (e) {
          200 == e.statusCode ? "function" == typeof o.success && (e.data = JSON.parse(e.data), o.success(e.data)) : "function" == typeof o.error && o.error("上传错误：" + e.statusCode + "；" + e.data), o.complete()
        },
        fail: function (e) {
