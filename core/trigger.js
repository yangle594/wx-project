module.exports = {
  ...
  run: function (t, s, i) {
    for (var n in this.taskList) null != this.taskList[n] && this.taskList[n].event === t && ("function" == typeof this.taskList[n].fun && this.taskList[n].fun(i), this.taskList[n] = null);
    "function" == typeof s && s()
  }
};